 ...
 */
function wpimages_val($arr,$key,$default='')
{
 ...
 * @param bool $die
 */
function wpimages_fatal($message, $title = "", $die = false)
{
 ...
 */
function wpimages_image_resize( $file, $max_w, $max_h, $crop = false, $suffix = null, $dest_path = null, $jpeg_quality = 90 ) {
