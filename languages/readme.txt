...
If you are interested in creating a language translation for Wp image resizer then
you've found the right place!  Your help is greatly appreciated and allows
Wp image resizer to be more easily used by people all over the world.
Wp image resizer uses the language that is configured for WordPress in wp-config.php
and so it can support any language for which a translation has been provided.

The language files used by WordPress and Wp image resizer are extremely simple
...
of these files in the wp-image-compression/languages folder and it will be used on 
all wpimage configuration pages.
...
Once the files are available, post a message on the Wp image resizer Support Forum at 
http://wordpress.org/support/plugin/wp-image-compression and let me know where to get
them.

Thank you for supporting Wp image resizer and all free software!
